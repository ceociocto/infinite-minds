...
import { Newspaper, FileText, Globe, Loader2 } from 'lucide-react';
import { ScrollArea } from '@/components/ui/scroll-area';

export const NewsPanel: React.FC = () => {
  const currentResult = useAgentStore((state) => state.currentResult);
  const showNewsPanel = useAgentStore((state) => state.showNewsPanel);
            ...
            <div className="space-y-4">
              {!currentResult ? (
                <div className="text-center py-8 text-gray-500 animate-pulse">
                  ...
                  <p className="text-sm">Generating news summary...</p>
                  <p className="text-xs mt-2 text-gray-400">Please wait while our AI agents work</p>
                </div>
              ) : (
                <>
                  {/* English Summary */}
                  <div className="p-3 bg-blue-50 rounded-lg border border-blue-100 animate-in fade-in slide-in-from-bottom-2 duration-300 delay-100">
                  ...
                  {/* Chinese Translation */}
                  <div className="p-3 bg-gray-50 rounded-lg border border-gray-100 animate-in fade-in slide-in-from-bottom-2 duration-300 delay-200">
                    <div className="flex items-center gap-2 mb-2">
